...
@section('content')
    <div class="container mx-auto py-8">
        ...
        {{-- 🔙 Back Button --}}
        <div class="mb-6">
            <x-ui.button href="{{ route('dashboard.jobs.index') }}" variant="secondary" size="sm">← Back to My
                Jobs</x-ui.button>
        </div>
        ...
        <div
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                ...
                <div>
                    ...
                    <p class="text-lg font-medium text-gray-900 dark:text-gray-100">
                        {{ $job->technologies_txt ?? 'Not specified' }}</p>
                </div>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3 mt-12">
                ...
                <x-ui.confirm-modal :action="route('dashboard.jobs.destroy', $job->id)" method="DELETE" title="Delete Job" :description="__('Deleting this job will remove all associated applications and analytics.')"
