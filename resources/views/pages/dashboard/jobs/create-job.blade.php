        ...
        <form action="{{ route('dashboard.jobs.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title"
                    class="w-full border border-emerald-100 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-emerald-500/30"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="salary_min" id="salary_min"
                        class="w-full border border-emerald-100 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-xl p-3"
            ...
            <div>
                ...
                <select name="work_type" id="work_type"
                    class="w-full border border-emerald-100 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-emerald-500/30" required>
