        ...
        <form action="{{ route('dashboard.jobs.update', $job->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" value="{{ old('title', $job->title) }}"
                    class="w-full px-4 py-2 rounded-xl border border-emerald-100 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500/30">
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                    class="w-full px-4 py-2 rounded-xl border border-emerald-100 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500/30">{{ old('description', $job->description) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="responsibilities" rows="3"
                    class="w-full px-4 py-2 rounded-xl border border-emerald-100 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500/30">{{ old('responsibilities', $job->responsibilities) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="qualifications" rows="3"
                    class="w-full px-4 py-2 rounded-xl border border-emerald-100 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500/30">{{ old('qualifications', $job->qualifications) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="benefits" rows="3"
                    class="w-full px-4 py-2 rounded-xl border border-emerald-100 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500/30">{{ old('benefits', $job->benefits) }}</textarea>
            </div>
