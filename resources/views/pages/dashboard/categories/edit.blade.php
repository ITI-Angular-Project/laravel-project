    ...
    <div class="max-w-3xl mx-auto space-y-8">
        <div class="flex items-center justify-between gap-4">
            <div>
                ...
                <h2 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Edit Category</h2>
                <p class="text-gray-600 dark:text-gray-400">Update how this category appears in filters and listings.</p>
            </div>
        ...
        <form method="POST" action="{{ route('dashboard.categories.update', $category) }}"
            ...
            <div>
                ...
                <input id="name" name="name" type="text" value="{{ old('name', $category->name) }}" maxlength="120"
