...
@section('content')
    <div x-data="{ darkMode: document.documentElement.classList.contains('dark') }" x-init="$watch('darkMode', value => document.documentElement.classList.toggle('dark', value))"
        ...
        <div class="container mx-auto py-6">
            ...
            <div class="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 mb-8">
                <div
                    class="rounded-2xl p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm
                        transition-colors duration-500 ease-in-out animate-in fade-in slide-in-from-bottom delay-100">
                ...
                <div
                    class="rounded-2xl p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm
                        transition-colors duration-500 ease-in-out animate-in fade-in slide-in-from-bottom delay-150">
                    <div class="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-500">New Applications
                    </div>
                    <div
                        class="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100 transition-colors duration-500">
                        {{ $newApplications }}</div>
                </div>

                <div
                    class="rounded-2xl p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm
                        transition-colors ease-in-out animate-in fade-in slide-in-from-bottom duration-500 delay-200">
                ...
                <div
                    class="rounded-2xl p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-sm
                        transition-colors ease-in-out animate-in fade-in slide-in-from-bottom duration-500 delay-250">
                    <div class="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-500">Total Applicants
                    </div>
                    <div
                        class="mt-2 text-3xl font-semibold text-gray-900 dark:text-gray-100 transition-colors duration-500">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
                ...
                <div
                    class="lg:col-span-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-5
                        transition-colors ease-in-out animate-in fade-in slide-in-from-bottom duration-500 delay-150">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4 transition-colors duration-500">
                        Recent Jobs</h3>
                    <table class="min-w-full text-sm transition-colors duration-500">
                        ...
                        <tbody>
                                ...
                                <tr
                                    ...
                                    <td class="py-2 capitalize">
                                        <span @class([
                                            ...
                                            'text-red-600' => !in_array($job->status, ['approved', 'pending']),
                                        ])>
                                            {{ ucfirst($job->status) }}
                                        </span>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3"
                                        class="py-3 text-center text-gray-500 dark:text-gray-400 transition-colors duration-500">
                ...
                {{-- 🔹 Quick Actions --}}
                <div
                    class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-5
                        transition-colors ease-in-out animate-in fade-in slide-in-from-right duration-500 delay-200">
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4 transition-colors duration-500">
                        Quick Actions</h3>
