...
@php($inputClasses = 'w-full px-4 py-2.5 rounded-xl border border-emerald-100 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500 transition')
@php($roleOptions = [
