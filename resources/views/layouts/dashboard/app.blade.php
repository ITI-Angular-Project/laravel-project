...
<body :class="{ 'dark': darkMode }"
    ...
    <div class="min-h-screen flex">
        ...
        <aside
            ...
            <!-- Brand / Collapse -->
            <div
                class="flex items-center justify-between px-4 h-16 border-b border-gray-200/50 dark:border-gray-800/50">
                <a href="{{ route('dashboard.home') }}"
                    class="flex items-center gap-2 group transition-transform duration-200 hover:scale-105">
                    <span
                        class="inline-flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 text-white font-bold shadow-lg shadow-indigo-500/30 transition-all duration-300 group-hover:shadow-xl group-hover:shadow-purple-500/40 group-hover:scale-110">H</span>
        ...
        <div class="flex-1 min-w-0 flex flex-col">
            <!-- Top Bar -->
            <header
                class="sticky top-0 z-30 bg-gradient-to-r from-white/90 via-white/95 to-white/90 dark:from-gray-900/90 dark:via-gray-900/95 dark:to-gray-900/90 backdrop-blur-xl border-b border-gray-200/60 dark:border-gray-800/60 shadow-sm">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <button
                            class="md:hidden p-2 rounded-lg hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-50 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-200 hover:scale-110"
                        ...
                        <h1
                            class="text-base sm:text-lg font-semibold tracking-tight bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-200 dark:to-white bg-clip-text text-transparent">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="relative" x-data="{ open: false }" @keydown.escape="open=false">
                            <button @click="open=!open"
                                ...
                                aria-haspopup="true" :aria-expanded="open.toString()">
                                <span
                                    class="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-600 text-white text-sm font-semibold shadow-lg shadow-indigo-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/40 hover:scale-110"
                                    aria-hidden="true">
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                ...
                                <a href="{{ route('dashboard.profile') }}"
                                    class="block px-4 py-2 text-sm hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-200">Profile</a>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left px-4 py-2 text-sm hover:bg-gradient-to-r hover:from-red-50 hover:to-red-100 dark:hover:from-red-900/20 dark:hover:to-red-800/20 transition-all duration-200">Log
                                        out</button>
                                </form>
                            </div>
                        </div>
