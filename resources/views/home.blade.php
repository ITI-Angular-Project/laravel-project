<x-app-layout>
        <!-- Hero Section -->
    <div class="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-indigo-950 dark:to-purple-950 overflow-hidden">
        <!-- Animated Background Elements -->
        <div class="absolute inset-0 overflow-hidden">
            <div class="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-indigo-300/50 to-purple-300/50 dark:from-indigo-500/25 dark:to-purple-500/25 rounded-full blur-3xl animate-blob"></div>
            <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-tr from-purple-300/50 to-pink-300/50 dark:from-purple-500/25 dark:to-pink-500/25 rounded-full blur-3xl animate-blob-reverse animation-delay-2000"></div>
            <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-gradient-to-r from-blue-300/40 to-indigo-300/40 dark:from-blue-500/20 dark:to-indigo-500/20 rounded-full blur-2xl animate-blob-spin animation-delay-4000"></div>
        </div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div class="text-center space-y-8">
                <!-- Badge -->
                <div class="inline-flex items-center px-4 py-2 bg-indigo-100 dark:bg-indigo-900/50 backdrop-blur-sm rounded-full text-indigo-700 dark:text-indigo-300 text-sm font-medium animate-fade-in-down border border-indigo-200 dark:border-indigo-800">
                ...
                <!-- Main Heading -->
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight animate-fade-in-up">
                    Find Your Dream Job
                    <span class="block mt-2 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">
                        Today
                    </span>
                </h1>

                <!-- Subheading -->
                <p class="max-w-2xl mx-auto text-lg sm:text-xl text-gray-700 dark:text-gray-300 animate-fade-in-up" style="animation-delay: 0.2s;">
                ...
                <div class="max-w-4xl mx-auto mt-10 animate-fade-in-up" style="animation-delay: 0.4s;">
                    <form action="{{ route('jobs') }}" method="GET" class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 space-y-4 border border-gray-200 dark:border-gray-700">
                ...
                <!-- Stats -->
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto pt-8 animate-fade-in-up" style="animation-delay: 0.6s;">
        ...
        <div class="absolute bottom-0 left-0 right-0 overflow-hidden">
            <svg class="w-full h-16 sm:h-24 fill-current text-white dark:text-gray-900 animate-wave" viewBox="0 0 1440 120" preserveAspectRatio="none">
                <path d="M0,64L80,69.3C160,75,320,85,480,80C640,75,800,53,960,48C1120,43,1280,53,1360,58.7L1440,64L1440,120L1360,120C1280,120,1120,120,960,120C800,120,640,120,480,120C320,120,160,120,80,120L0,120Z"></path>
            </svg>
            <svg class="w-full h-16 sm:h-24 fill-current text-white/50 dark:text-gray-900/50 absolute bottom-0 animate-wave-slow" viewBox="0 0 1440 120" preserveAspectRatio="none">
                <path d="M0,80L80,74.7C160,69,320,59,480,64C640,69,800,91,960,96C1120,101,1280,91,1360,85.3L1440,80L1440,120L1360,120C1280,120,1120,120,960,120C800,120,640,120,480,120C320,120,160,120,80,120L0,120Z"></path>
            </svg>
        </div>
    </div>
    ...
    <div class="py-16 bg-white dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">Start your journey to finding the perfect job in three simple steps</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center p-6 rounded-xl bg-white dark:bg-gray-800 hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Browse through thousands of job listings from top companies</p>
                </div>
...
<div class="py-16 bg-gray-50 dark:bg-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            ...
            <div class="w-20 h-1 bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 mx-auto rounded-full"></div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Technology Category -->
            <a href="{{ route('jobs', ['category' => 'technology']) }}" 
               class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex flex-col items-center text-center space-y-4">
                    <!-- Icon Container -->
                    <div class="w-20 h-20 bg-gradient-to-br from-indigo-100 to-indigo-50 dark:from-indigo-900/30 dark:to-indigo-800/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Insurance Category -->
            <a href="{{ route('jobs', ['category' => 'insurance']) }}" 
               class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex flex-col items-center text-center space-y-4">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-100 to-purple-50 dark:from-purple-900/30 dark:to-purple-800/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Banking Category -->
            <a href="{{ route('jobs', ['category' => 'banking']) }}" 
               class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex flex-col items-center text-center space-y-4">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-50 dark:from-blue-900/30 dark:to-blue-800/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Automotive Category -->
            <a href="{{ route('jobs', ['category' => 'automotive']) }}" 
               class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 hover:border-red-500 dark:hover:border-red-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex flex-col items-center text-center space-y-4">
                    <div class="w-20 h-20 bg-gradient-to-br from-red-100 to-red-50 dark:from-red-900/30 dark:to-red-800/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Marketing Category -->
            <a href="{{ route('jobs', ['category' => 'marketing']) }}" 
               class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex flex-col items-center text-center space-y-4">
                    <div class="w-20 h-20 bg-gradient-to-br from-green-100 to-green-50 dark:from-green-900/30 dark:to-green-800/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <!-- Government Category -->
            <a href="{{ route('jobs', ['category' => 'government']) }}" 
               class="group relative bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-700 hover:border-amber-500 dark:hover:border-amber-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                <div class="flex flex-col items-center text-center space-y-4">
                    <div class="w-20 h-20 bg-gradient-to-br from-amber-100 to-amber-50 dark:from-amber-900/30 dark:to-amber-800/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
...
<div class="py-16 bg-white dark:bg-gray-900">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('jobs', 1) }}" class="group bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                <!-- Job Image -->
            ...
            <a href="{{ route('jobs', 2) }}" class="group bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                <!-- Job Image -->
            ...
            <a href="{{ route('jobs', 3) }}" class="group bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                <!-- Job Image -->
            ...
            <a href="{{ route('jobs', 4) }}" class="group bg-gray-50 dark:bg-gray-800 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                <!-- Job Image -->
    ...
    <div class="py-16 bg-gray-50 dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <a href="#" class="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <!-- Job Image -->
                    <div class="relative h-48 overflow-hidden bg-gradient-to-br from-indigo-500 to-purple-600">
                        <img src="https://images.unsplash.com/photo-1498050108023-c5249f4df085?w=400&h=300&fit=crop" 
                ...
                <a href="#" class="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-purple-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <!-- Job Image -->
                    <div class="relative h-48 overflow-hidden bg-gradient-to-br from-purple-500 to-pink-600">
                ...
                <a href="#" class="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <!-- Job Image -->
                    <div class="relative h-48 overflow-hidden bg-gradient-to-br from-blue-500 to-cyan-600">
                ...
                <a href="#" class="group bg-white dark:bg-gray-900 rounded-2xl overflow-hidden border border-gray-200 dark:border-gray-700 hover:border-green-500 dark:hover:border-green-400 transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
                    <!-- Job Image -->
                    <div class="relative h-48 overflow-hidden bg-gradient-to-br from-green-500 to-emerald-600">
